...
import com.itrecruitmentapi.shared.Constants;
...
public class TokenProvider {
    ...
    public String generateToken(Authentication authentication) {
        ...
        final AccountEntity accountEntity = this.accountRepository.findByUsername(authentication.getName()).get();

        return Jwts.builder()
                .setSubject(authentication.getName())
                .claim(Constants.ACCOUNT_KEY, accountEntity.getAccountId())
